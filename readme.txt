...
knock_in_strike_pct	敲入执行价格（百分比，小数形式）
participation_rate	敲入参与率（百分比，小数形式）
...
x_perc	理论收益曲线中的标的最终价格百分比数组（0–150%）
payoff_knockin	理论收益曲线中“敲入已触发”情形下的收益率（%）
payoff_no_knockin	理论收益曲线中“未发生敲入”情形下的收益率（%）
min_payoff	根据最大亏损比例计算得到的最低收益率（%）
